...
YANGI: Faqat botning keraksiz xabarlarini o'chirish, o'yin tugaganda bot xabarlarini tozalash
"""
...
waiting_for_admin_add: Dict[int, bool] = {}  # admin -> waiting for user_id
